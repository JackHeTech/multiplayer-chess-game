...
const JoinGame = (props) => {
    ...
    return <div>
        ...
        <h3 style = {{textAlign: "center"}}>Made with ❤️ by <a href = 'https://jackhe.codes/' target = '_blank'>Jack He</a>. Subscribe to my <a href = 'https://www.youtube.com/channel/UC9xFO-llZ2ontatfj9LtLxw' target = '_blank'>YouTube channel</a></h3>
    </div>
}
